...
const LogoutIcon = (): JSX.Element => (
	<Icon tabIndex={0} aria-label="log out" role="button" style={{ width: '25px' }} xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 512 512">
		<g>
			<g xmlns="http://www.w3.org/2000/svg">
				<g>
					<path d="M255.15,468.625H63.787c-11.737,0-21.262-9.526-21.262-21.262V64.638c0-11.737,9.526-21.262,21.262-21.262H255.15    c11.758,0,21.262-9.504,21.262-21.262S266.908,0.85,255.15,0.85H63.787C28.619,0.85,0,29.47,0,64.638v382.724    c0,35.168,28.619,63.787,63.787,63.787H255.15c11.758,0,21.262-9.504,21.262-21.262    C276.412,478.129,266.908,468.625,255.15,468.625z" data-original="#d1dce5" />
				</g>
			</g>
			<g xmlns="http://www.w3.org/2000/svg">
				<g>
