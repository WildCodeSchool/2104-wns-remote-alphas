...
const SendIcon = (): JSX.Element => (
    <Icon style={{ width: '40px', height: '40px' }} xmlns="http://www.w3.org/2000/svg" x="0" y="0" enable-background="new 0 0 512 512" viewBox="0 0 512 512">
        <g>
            <g><g><g><g><g><g><circle cx="256" cy="256" fill="#ff7d81" r="256" /></g></g></g></g></g></g>
